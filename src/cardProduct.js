...
export function renderCatalog() {
        ...
        for (const productCatalog of catalog) {
            const cardProduct = ` <div class="border-solid w-48 m-4 flex flex-col p-2 justify-between shadow-xl shadow-slate-400 rounded-lg group ${productCatalog.apple ? 'Aplle' : 'Samsung'}" id="card-product-${productCatalog.id}">
        <img 
